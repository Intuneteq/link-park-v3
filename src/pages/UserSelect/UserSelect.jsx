  ...
  return (
    <main className="UserSelect column-flex">
      ...
      <section className="app__flex-2 UserSelect__container">
        <div onClick={() => setAnimate({ ...animate, activeUser: 0 })} className={toggleActiveClassName(0)}>
        ...
        <div onClick={() => setAnimate({ ...animate, activeUser: 1 })} className={toggleActiveClassName(1)}>
          <div className="img-size">
            <img
      ...
      <button onClick={() =>navigate('/signin')} className="btn-primary"> Next </button>
    </main>
  );
};
